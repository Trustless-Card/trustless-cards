  ...
  const addInput = async (str: string) => {
    if (rollups) {
      try {
        ...
        console.log("Input adicionado:", str);
      } catch (e) {
        console.log(`${e}`);
      }
    }
    ...
    <div className="text-center max-w-screen-xl mx-auto mb-10" id="input">
      <div className="flex gap-4 md:gap-14 flex-wrap mt-8 justify-center md:mt-10 mx-10 md:mx-0">
        <div className="w-[95%] md:w-[30%] mb-8 relative group">
          ...
          <div className="bg-black border-gold h-[350px] relative z-10">
            <div className="text-center">
              <div className="flex flex-col justify-center items-center gap-4">
                <div className="w-20 h-20 rounded-full bg-[#333] border-2 border-[#161d15] flex justify-center items-center">
                  <svg
